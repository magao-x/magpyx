...
def measure_and_estimate_phase_vector(config_params=None, client=None, dmstream=None, camstream=None, darkim=None, wfsmask=None, param_func=get_magaox_fitting_params, restore_dm=True, default_steps=None, steps_noxy=None):
    ...
    '''
    # mask the shmims by the wfsmask
    ...
    shmim_mask = np.zeros((N,N), dtype=bool)
    shmim_mask[fitting_params['fitting_slice']] = wfsmask
    ...
    #logger.info(f'Estimated phase RMS within WFS mask: {np.std(phase_pttrem):.3} (rad)')
...
def compute_control_matrix(config_params, nmodes=None, write=True, param_func=get_magaox_fitting_params):
    '''
...
def estimate_oneshot(config_params, update_shmim=True, write_out=False, client=None, dmstream=None, camstream=None, darkim=None, param_func=get_magaox_fitting_params, shmim_mask=None, restore_dm=True, steps_noxy=None, default_steps=None):
    ...
    return estdict, fitting_params, imcube
...
def estimate_response_matrix(image_cube, params, processes=2, gpus=None, fix_xy_to_first=False, steps_noxy=None, default_steps=None):
    '''
